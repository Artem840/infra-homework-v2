...
Необходимо добавить в ноду возможность подключать .yml файлы через обычный вызов require и import.

Для этого нужно реализовать лоадеры в `loader.cjs` / `loader.mjs`.
...
[Документация](https://nodejs.org/api/module.html#hooks) по esm модулям.
